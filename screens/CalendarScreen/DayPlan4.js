...
export default function DayPlan4() {
  return (
        ...
        <View style={styles.calItem}>
          <View style={styles.mealRow}>
            ...
            <View style={styles.time}>
              ...
              <Text style={themes.time}> 10:30am</Text>
            </View>
          </View>
          <Text style={themes.time}>Pastries and Coffee from Coho</Text>
        </View>
        <View style={styles.calItem}>
          <View style={styles.mealRow}>
            ...
            <View style={styles.time}>
              <Feather name="clock" size={14} color="black" />
              <Text style={themes.time}> 12:30pm</Text>
            </View>
          </View>
          <Text style={themes.time}>PhoHua with mom</Text>
        </View>
        <View style={styles.calItem}>
          <View style={styles.mealRow}>
          ...
          <Text style={themes.time}>Sushi making</Text>
        </View>
      </View>
    </View>
  );
